...
CREATE TABLE `wtkNotifications` (
  ...
  `AddedByUserUID` INT(10) unsigned DEFAULT 0,
  `DelDate` DATETIME DEFAULT NULL,
  `DeletedByUserUID` INT(10) unsigned DEFAULT NULL,
...
CREATE TABLE `wtkProspectStaff` (
  ...
  `Email` varchar(100),
  `EmailsSent` smallint(6) DEFAULT '0',
  `EmailsOpened` smallint(6) DEFAULT '0',
  `LinksClicked` smallint(6) DEFAULT '0',
