...
CREATE TABLE `wtkNotifications` (
  ...
  `EmailAlso` enum('N','Y') DEFAULT 'N',
  `SmsAlso` enum('N','Y') DEFAULT 'N',
  `SeenDate` DATETIME DEFAULT NULL,
  `SeenByUserUID` INT UNSIGNED,
  `CloseDate` DATETIME DEFAULT NULL,
  `CloseByUserUID` INT UNSIGNED,
...
CREATE TABLE `wtkProspects` (
  ...
  `MonthlyWebsiteVisits` varchar(20) DEFAULT NULL,
  `MonthlyWebsiteVisitsGrowth` varchar(20) DEFAULT NULL,
  `CEOFirstName` varchar(40) DEFAULT NULL,
  `CEOLastName` varchar(40) DEFAULT NULL,
  `CEOEmail` varchar(60) DEFAULT NULL,
  `CEOTwitter` varchar(60) DEFAULT NULL,
  `CEOLinkedIn` varchar(280) DEFAULT NULL,
  `OtherSocial` varchar(80) DEFAULT NULL,
  `CompanySize` varchar(80) DEFAULT NULL,
  `NumberOfEmployees` varchar(20) DEFAULT NULL,
  `AnnualSales` varchar(255) DEFAULT NULL,
  `FundingDate` varchar(60) DEFAULT NULL,
  `FundingAmount` varchar(60) DEFAULT NULL,
  `FundingType` varchar(120) DEFAULT NULL,
  `FundingLink` varchar(480) DEFAULT NULL,
  `Top5Investors` varchar(800) DEFAULT NULL,
  `NumLeadInvestors` smallint DEFAULT NULL,
  `NumInvestors` smallint DEFAULT NULL,
  `SpendIT` int DEFAULT NULL,
  `SpendSoftware` int DEFAULT NULL,
  `SpendCommunications` int DEFAULT NULL,
  `SpendServices` int DEFAULT NULL,
  `SpendHardware` int DEFAULT NULL,
  `SpendOtherIT` int DEFAULT NULL,
  `SICCode` int DEFAULT NULL,
  `FoundingYear` varchar(20) DEFAULT NULL,
  `B2BorB2C` varchar(20) DEFAULT NULL,
...
CREATE TABLE `wtkProspectStaff` (
  ...
  `AllowContact` enum('N','Y') DEFAULT 'Y',
  `InternalNote` text,
  PRIMARY KEY (`UID`),
...
CREATE TABLE `wtkReports` (
  ...
  `TestMode` enum('N','Y') DEFAULT 'N',
  `HideFooter` enum('N','Y') DEFAULT 'N',
  `RptType` varchar(10),
...
CREATE TABLE `wtkUserNote` (
  ...
  `FlagImportant` enum('N','Y') DEFAULT 'N',
  `Notes` TEXT NOT NULL,
  PRIMARY KEY (`UID`),
