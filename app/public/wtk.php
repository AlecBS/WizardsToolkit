<?php
// This page is the entry point for the WTK mobile app (iPhone or Android)
...
$pgTmp .= '<a target="_blank" href="https://wizardstoolkit.com/pricing.php">Wizard&rsquo;s Toolkit</a>' . "\n";
...
$pgPromo =<<<htmVAR
    ...
    <p>This demo shows a fraction of what comes with
      <a target="_blank" href="https://wizardstoolkit.com/pricing.php">Wizard&rsquo;s Toolkit</a>
...
$pgHtm .= wtkFormHidden('pgPathVar', '');

$pgMobile = wtkGetParam('mobile');
if ($pgMobile != ''): // this makes website work for iOS and Android apps; have Xcode point to this page ?mobile=ios
    $pgMobile = wtkReplace($pgMobile, 'ios?phone=iPhone','ios');
    $pgHtm .= wtkFormHidden('pgMobileAppVar', $pgMobile);
    if ($pgMobile == 'ios'):
...
if (($gloDeviceType == 'phone') || ($pgMobile == 'ios')):
    ...
    if ($pgMobile == ''):
        $pgHtm .= wtkFormHidden('pgMobileAppVar', 'pwa');
    endif;
endif;
