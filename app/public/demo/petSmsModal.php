...
<div class="row">
    <div class="col s12"><br>
        ...
        &nbsp;&nbsp;
        <button id="sendSmsBtn" type="button" class="btn-primary btn-small b-shadow waves-effect waves-light modal-close" onclick="Javascript:alert('feature disabled for demo')">Send</button>
        </span></h3>
        <br>
