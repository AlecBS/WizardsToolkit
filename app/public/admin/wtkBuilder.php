...
if (wtkGetParam('wtkRFBBrPHPfilename') != ''):
    $pgBrPHP = wtkLoadInclude('incWTKbrowseTemplate.php');
...
if (wtkGetParam('wtkRFBUpPHPfilename') != ''):
    $pgFormPHP = wtkLoadInclude('incWTKformTemplate.php');
    ...
    for ($i = 0; $i < sizeof($pgFieldArray); ++$i):
        ...
        if (($pgField != 'UID') && ($pgField != 'GUID')):
            ...
            if (strtolower($pgField) == 'newfilename'):
                $pgNewDataRows .= '$pgHtm .= ' . "wtkFormFile('@Table@','FilePath','/imgs/','NewFileName','Photo','$pgGrid');" . "\n";
                ...
                if (substr(strtolower($pgField), -4, 4) == 'note'):
                    if ($pgGrid == ''):
                        ...
                        $pgNewDataRows .= '$pgHtm .= wtkFormTextArea(\'@Table@\', \'' . $pgField . "','','$pgGrid');" . "\n";
                    endif;
                else:
                    $pgDataType = '';
                    ...
                    if ($pgDataType == ''):
                        if ($pgGrid == ''):
                            ...
                            $pgNewDataRows .= ",'text','','$pgGrid');" . "\n";
                        endif;
                    else: // $pgDataType != ''
                        if ($pgGrid == ''):
                            $pgNewDataRows .= ", '$pgDataType');" . "\n";
                        else:
                            $pgNewDataRows .= ", '$pgDataType','','$pgGrid');" . "\n";
                        endif;
                    endif; // $pgDataType != ''
                endif;  // text field
