...
$pgTabBar =<<<htmVAR
<p>View: &nbsp;
<a onclick="JavaScript:ajaxFillDiv('/admin/moneyStats','dwmyChart','dwmyChart','d')">Daily</a> &nbsp;
<a onclick="JavaScript:ajaxFillDiv('/admin/moneyStats','dwmyChart','dwmyChart','w')">Weekly</a> &nbsp;
<a onclick="JavaScript:ajaxFillDiv('/admin/moneyStats','dwmyChart','dwmyChart','m')">Monthly</a> &nbsp;
<a onclick="JavaScript:ajaxFillDiv('/admin/moneyStats','dwmyChart','dwmyChart','y')">Yearly</a>
</p>
htmVAR;
